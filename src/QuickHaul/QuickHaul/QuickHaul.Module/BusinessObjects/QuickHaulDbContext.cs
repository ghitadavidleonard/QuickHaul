...
{
    [TypesInfoInitializer(typeof(DbContextTypesInfoInitializer<QuickHaulEFCoreDbContext>))]
    public class QuickHaulEFCoreDbContext : DbContext
    {
        public QuickHaulEFCoreDbContext(DbContextOptions<QuickHaulEFCoreDbContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<QuickHaul.Module.BusinessObjects.ApplicationUserLoginInfo>(b =>
            {
