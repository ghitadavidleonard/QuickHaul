...
using QuickHaul.Blazor.Server.Services;
using QuickHaul.WebApi.JWT;
using System.Text;
...
namespace QuickHaul.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                builder.UseApplication<QuickHaulBlazorApplication>();
                ...
                builder.Modules
                    ...
                    .Add<QuickHaul.Module.QuickHaulModule>()
                    .Add<QuickHaulBlazorModule>();
                builder.ObjectSpaceProviders
                    .AddSecuredEFCore(options =>
                    {
                        options.PreFetchReferenceProperties();
                    })
                    .WithDbContext<QuickHaul.Module.BusinessObjects.QuickHaulEFCoreDbContext>((serviceProvider, options) =>
                    {
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(QuickHaul.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(QuickHaul.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Title = "QuickHaul API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the QuickHaul.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "QuickHaul WebApi v1");
                });
            }
            else
            {
